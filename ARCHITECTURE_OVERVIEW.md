...
- **BotBrain / autoplay**: Bot decision engine (`io_layer/bot_brain.py`) used by `BotInputSource`; supports personas and soak/testing modes. Integrated with telemetry and scenario harness. See `docs/BOTBRAIN_OVERVIEW.md` for the bot input pipeline and bot-specific telemetry summary fields.
