...
try:
    ...
    print(f"  ❌ FAIL: Cannot create game state: {e}\n")
    import traceback
    traceback.print_exc()
    sys.exit(1)
...
try:
    ...
    print(f"  ❌ FAIL: Cannot create Ruby Heart: {e}\n")
    sys.exit(1)
...
try:
    ...
    print(f"  ❌ FAIL: Cannot create services: {e}\n")
    import traceback
    traceback.print_exc()
    sys.exit(1)
...
try:
    ...
    print(f"  ❌ FAIL: Exception during pickup: {e}\n")
    import traceback
    traceback.print_exc()
    sys.exit(1)
...
try:
    ...
    if not result.portal_entry:
        print(f"  ❌ FAIL: Portal entry not detected")
    ...
    print(f"  ✅ Portal entry detected!")
    print(f"  ✅ Player on portal at ({player.x}, {player.y})\n")
    
except Exception as e:
    print(f"  ❌ FAIL: Exception during movement: {e}\n")
    import traceback
    traceback.print_exc()
    sys.exit(1)
