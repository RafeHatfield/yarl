...
class TestEquipmentEntityIntegration:
    ...
    def test_entity_with_both_equipment_and_equippable(self):
        ...
        entity = Entity(0, 0, '@', (255, 255, 255), 'Player', 
                       equipment=equipment, equippable=equippable)
    ...
    def test_entity_component_linking(self):
        ...
        entity = Entity(0, 0, '@', (255, 255, 255), 'Player',
                       fighter=fighter, equipment=equipment, inventory=inventory)
...
class TestEquipmentInventoryIntegration:
    ...
    def setup_method(self):
        ...
        self.player = Entity(0, 0, '@', (255, 255, 255), 'Player',
                           fighter=self.fighter, equipment=self.equipment, 
    ...
    def test_inventory_use_item_with_use_function(self):
        ...
        potion = Entity(0, 0, '!', (255, 255, 255), 'Healing Potion', item=item_component)
...
class TestEquipmentEngineIntegration:
    ...
    def test_engine_equipment_replacement_messages(self):
        ...
        old_sword = Entity(0, 0, '/', (255, 255, 255), 'Old Sword', equippable=old_sword_equippable)
        old_sword.name = 'Old Sword'
        
        new_sword_equippable = Equippable(EquipmentSlots.MAIN_HAND, power_bonus=3)
        new_sword = Entity(0, 0, '/', (255, 255, 255), 'New Sword', equippable=new_sword_equippable)
...
class TestEquipmentMenuIntegration:
    ...
    def test_equipment_display_in_character_screen(self):
        ...
        shield = Entity(0, 0, '[', (255, 255, 255), 'Shield', equippable=shield_equippable)
        shield.name = 'Shield'
    ...
    def test_equipment_stat_display_data(self):
        ...
        # Equip items
        weapon_equippable = Equippable(EquipmentSlots.MAIN_HAND, power_bonus=4, defense_bonus=1)
        weapon = Entity(0, 0, '/', (255, 255, 255), 'Magic Sword', equippable=weapon_equippable)
...
class TestEquipmentSystemRobustness:
    ...
    def test_equipment_memory_management(self):
        ...
        for i in range(100):
            ...
            item = Entity(0, 0, '/', (255, 255, 255), f'Item{i}', equippable=item_equippable)
