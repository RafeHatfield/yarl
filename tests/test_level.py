...
class TestLevelInitialization:
    ...
    def test_level_custom_initialization(self):
        ...
        level = Level(
            current_level=5, current_xp=100, level_up_base=300, level_up_factor=200
        )
    ...
    def test_level_initialization_edge_cases(self):
        ...
        level_zero = Level(
            current_level=0, current_xp=0, level_up_base=0, level_up_factor=0
        )
