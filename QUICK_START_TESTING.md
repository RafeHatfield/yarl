...
- 👹 **Only 2 weak orcs** (safe testing)

### **Level 2** - Combat & Loot
- 🎁 **11 chests total** (test loot quality)
- 👹 **Tougher combat** (6 orcs + 3 trolls)
- 🏥 **30 healing potions** (survive the fights)
- 🛡️ **Better equipment** (plate armor, greatsword)
- 💪 **Buff potions** (speed, heroism, protection)

### **Level 3+** - Actual Vaults
- 🏰 **80% vault spawn rate** on levels 1-2
